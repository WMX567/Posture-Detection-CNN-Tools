...
vision_path = dir_path + '/PostureCodes/'
truth_path = dir_path + '/Ground_Truth/'
output_path = dir_path + '/Confusion_Matrix/'
param_path = dir_path + '/truth_correspond.csv'
...
if __name__ == "__main__":
    ...
    new_path = output_path + vision_filename + '_CM/'
    os.makedirs(new_path)
    for i in range(len(truth)):
        print_stdout = sys.stdout
        out_file = open(new_path + options[i] + '_CM.txt', 'w')
        sys.stdout = out_file
